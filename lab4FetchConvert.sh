...
git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/lab4.git # add a remote for the student repository
...
a2pdf --noperl-syntax Lab4Code/ShapeDrawer.java > ../grading/Lab4/$1.pdf # convert the Java file to PDF
