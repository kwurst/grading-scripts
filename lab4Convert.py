...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Lab4Code/ShapeDrawer.java -o ShapeDrawer.java.pdf')
    os.system('git log > log.txt')
    os.system('a2pdf --noperl-syntax --noline-numbers log.txt -o log.txt.pdf')
    os.system('pdftk ShapeDrawer.java.pdf log.txt.pdf cat output ' + dir + '.pdf')
    os.remove('ShapeDrawer.java.pdf')
