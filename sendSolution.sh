...
cp -r ../../../Labs/$2/$2'Solution' ./$2'Solution' # copy the graded assignment to student repository

git add $2'Solution' # add the graded assignment
git commit -m"$2 Solution" # commit the graded assignment
