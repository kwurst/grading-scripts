...
cd Project2 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/project2.git # add a remote for the student repository
...
a2pdf --noperl-syntax Project2Code/Cashier.java > ../grading/Project2/$1Cashier.pdf
a2pdf --noperl-syntax Project2Code/Invoice.java > ../grading/Project2/$1Invoice.pdf
pdftk ../grading/Project2/$1Cashier.pdf ../grading/Project2/$1Invoice.pdf cat output ../grading/Project2/$1.pdf
rm ../grading/Project2/$1Cashier.pdf
rm ../grading/Project2/$1Invoice.pdf
