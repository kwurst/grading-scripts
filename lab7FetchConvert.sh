...
cd Lab7 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/lab7.git # add a remote for the student repository
...
cp Lab7PartialSolution.doc ../grading/Lab7/$1.doc 
