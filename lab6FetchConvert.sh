...
cd Lab6 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/lab6.git # add a remote for the student repository
...
a2pdf --noperl-syntax Lab6Code/StudentCollection.java > ../grading/Lab6/$1.pdf # convert the Java file to PDF
