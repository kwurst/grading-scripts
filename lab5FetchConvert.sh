...
cd Lab5 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/lab5.git # add a remote for the student repository
...
a2pdf --noperl-syntax Lab5Code/CarFuelTank.java > ../grading/Lab5/$1CarFuelTank.pdf # convert the Java file to PDF
a2pdf --noperl-syntax Lab5Code/Lab5.java > ../grading/Lab5/$1Lab5.pdf # convert the Java file to PDF
pdftk ../grading/Lab5/$1Lab5.pdf ../grading/Lab5/$1CarFuelTank.pdf cat output ../grading/Lab5/$1.pdf
rm ../grading/Lab5/$1Lab5.pdf
rm ../grading/Lab5/$1CarFuelTank.pdf
