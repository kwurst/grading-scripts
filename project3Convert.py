...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Project3Code/LineItem.java -o LineItem.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Project3Code/Invoice.java -o Invoice.java.pdf')
    os.system('git log | a2pdf --noperl-syntax --noline-numbers --title "git log" -o log.pdf')
    os.system('pdftk LineItem.java.pdf Invoice.java.pdf log.pdf cat output ' + dir + '.pdf')
    os.remove('LineItem.java.pdf')
    os.remove('Invoice.java.pdf')
    os.remove('log.pdf')
    os.chdir('..')
