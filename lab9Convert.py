...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Lab9Code/Person.java -o Person.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab9Code/Student.java -o Student.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab9Code/Employee.java -o Employee.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab9Code/Faculty.java -o Faculty.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab9Code/Staff.java -o Staff.java.pdf')
    os.system('git log > log.txt')
    os.system('a2pdf --noperl-syntax --noline-numbers log.txt -o log.txt.pdf')
    os.system('pdftk Person.java.pdf Student.java.pdf Employee.java.pdf Faculty.java.pdf Staff.java.pdf log.txt.pdf cat output ' + dir + '.pdf')
    os.remove('Person.java.pdf')
    os.remove('Student.java.pdf')
    os.remove('Employee.java.pdf')
    os.remove('Faculty.java.pdf')
    os.remove('Staff.java.pdf')
