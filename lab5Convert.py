...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Lab5Code/CarFuelTank.java -o CarFuelTank.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab5Code/Lab5.java -o Lab5.java.pdf')
    os.system('git log > log.txt')
    os.system('a2pdf --noperl-syntax --noline-numbers log.txt -o log.txt.pdf')
    os.system('pdftk Lab5.java.pdf CarFuelTank.java.pdf log.txt.pdf cat output ' + dir + '.pdf')
    os.remove('Lab5.java.pdf')
    os.remove('CarFuelTank.java.pdf')
