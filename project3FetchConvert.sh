...
cd Project3 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/project3.git # add a remote for the student repository
...
a2pdf --noperl-syntax Project3Code/Invoice.java > ../grading/Project3/$1Invoice.pdf
a2pdf --noperl-syntax Project3Code/LineItem.java > ../grading/Project3/$1LineItem.pdf
pdftk ../grading/Project3/$1Invoice.pdf ../grading/Project3/$1LineItem.pdf cat output ../grading/Project3/$1.pdf
rm ../grading/Project3/$1Invoice.pdf
rm ../grading/Project3/$1LineItem.pdf
