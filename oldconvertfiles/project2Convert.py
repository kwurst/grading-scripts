...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Project2Code/Cashier.java -o Cashier.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Project2Code/Invoice.java -o Invoice.java.pdf')
    os.system('git log | a2pdf --noperl-syntax --noline-numbers --title "git log" -o log.pdf')
    os.system('pdftk Cashier.java.pdf Invoice.java.pdf log.pdf cat output ' + dir + '.pdf')
    os.remove('Cashier.java.pdf')
