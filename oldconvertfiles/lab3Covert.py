...
for dir in onlydirectories:
    print(dir)
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Lab2Code/Person.java -o Person.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab2Code/Lab2.java -o Lab2.java.pdf')
    os.system('git log > log.txt')
    os.system('a2pdf --noperl-syntax --noline-numbers log.txt -o log.txt.pdf')
    os.system('pdftk Person.java.pdf Lab2.java.pdf log.txt.pdf cat output ' + dir + '.pdf')
    os.remove('Person.java.pdf')
    os.remove('Lab2.java.pdf')
