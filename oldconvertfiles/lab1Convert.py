...
for dir in onlydirectories:
    os.chdir(dir)
    os.system('a2pdf --noperl-syntax --noline-numbers Lab1Code/HelloWorld.java -o HelloWorld.java.pdf')
    os.system('a2pdf --noperl-syntax --noline-numbers Lab1.txt -o Lab1.txt.pdf')
    os.system('pdftk HelloWorld.java.pdf Lab1.txt.pdf cat output ' + dir + '.pdf')
    os.remove('HelloWorld.java.pdf')
    os.remove('Lab1.txt.pdf')
    os.chdir('..')
