...
cd Project1 # folder for local repository

git remote add ${1%%-*} git@bitbucket.org:${1%%-*}/project1.git # add a remote for the student repository
...
a2pdf --noperl-syntax Project1Code/Product.java > ../grading/Project1/$1Product.pdf
a2pdf --noperl-syntax Project1Code/UserInterface.java > ../grading/Project1/$1UserInterface.pdf
pdftk ../grading/Project1/$1Product.pdf ../grading/Project1/$1UserInterface.pdf cat output ../grading/Project1/$1.pdf
rm ../grading/Project1/$1Product.pdf
rm ../grading/Project1/$1UserInterface.pdf
