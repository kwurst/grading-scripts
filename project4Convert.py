...
for dir in onlydirectories:
    ...
    os.system('pdftk Shape.java.pdf ThreeDimensionalShape.java.pdf Cone.java.pdf Sphere.java.pdf Cube.java.pdf Cylinder.java.pdf TwoDimensionalShape.java.pdf Triangle.java.pdf Rectangle.java.pdf Circle.java.pdf log.pdf cat output ' + dir + '.pdf')
